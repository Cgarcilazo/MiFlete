          ...
          <div class="block-form">
            <ValidationProvider
              ...
              <div class="input-group">
                <input
                  id="provincia-desde"
                  v-model="computedRequest['province_origin']"
                  type="text"
                  class="form-control"
            ...
            <ValidationProvider
              ...
              <div class="input-group">
                <input
                  id="ciudad-desde"
                  v-model="computedRequest['city_origin']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"
            ...
            <ValidationProvider
              ...
              <input
                id="calle-desde"
                v-model="computedRequest['street_origin']"
                type="text"
                class="form-control"
                :class="{ 'has-errors': errors.length }"/>
              <span class="red-text">
            ...
            <div class="row no-gutters address-info mt-4">
              <ValidationProvider
                ...
                <input
                  id="numero-desde"
                  v-model="computedRequest['street_number_origin']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
              ...
              <ValidationProvider
                ...
                <input
                  id="piso-desde"
                  v-model="computedRequest['flat_number_origin']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
              ...
              <ValidationProvider
                ...
                <input
                  ...
                  v-model="computedRequest['flat_letter_origin']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
            ...
            <ValidationProvider
              ...
              <VueTimepicker
                v-model="computedRequest.preferred_hour"/>
              <span class="red-text">
                {{ errors[0] }}
              </span>
            </ValidationProvider>
            <ValidationProvider
              ...
              <VueTimepicker
                v-model="computedRequest.range_hour_from"/>
              <VueTimepicker
                v-model="computedRequest.range_hour_to"/>
              <span class="red-text">
                {{ errors[0] }}
              </span>
            </ValidationProvider>
          ...
          <div class="block-form">
            <ValidationProvider
              ...
              <div class="input-group">
                <input
                  id="provincia-hasta"
                  v-model="computedRequest['province_destination']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"
                  placeholder="Seleccionar Provincia"/>
            ...
            <ValidationProvider
              ...
              <div class="input-group">
                <input
                  id="ciudad-hasta"
                  v-model="computedRequest['city_destination']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"
                  placeholder="Seleccionar Ciudad"/>
            ...
            <ValidationProvider
              ...
              <input
                id="calle-hasta"
                v-model="computedRequest['street_destination']"
                type="text"
                class="form-control"
                :class="{ 'has-errors': errors.length }"/>
              <span class="red-text">
            ...
            <div class="row no-gutters address-info mt-4">
              <ValidationProvider
                ...
                <input
                  id="numero-hasta"
                  v-model="computedRequest['street_number_destination']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
              ...
              <ValidationProvider
                ...
                <input
                  id="piso-hasta"
                  v-model="computedRequest['flat_number_destination']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
              ...
              <ValidationProvider
                ...
                <input
                  ...
                  v-model="computedRequest['flat_letter_destination']"
                  type="text"
                  class="form-control"
                  :class="{ 'has-errors': errors.length }"/>
                <span class="red-text">
      ...
      <div>
        ...
        <div class="block-form">
          <ValidationProvider
            ...
            <div class="input-group">
              <textarea
                v-model="computedRequest.description"
                class="form-control"
        ...
        <div class="block-form">
          <div class="form-group form-check">
            <input
              id="operarios"
              v-model="computedRequest['need_more_carriers']"
              type="checkbox"
          ...
          <div class="d-flex">
            <div
              ...
              <input
                id="si-origen"
                v-model="computedRequest['is_elevator_origin']"
                type="radio"
          ...
          <div class="ascensor-radio mt-4">
            ...
            <div class="d-flex">
              <div
                ...
                <input
                  id="si-destino"
                  v-model="computedRequest['is_elevator_destination']"
                  type="radio"
          ...
          <ValidationProvider
            ...
            <div class="input-group">
              <textarea
                id="aclaraciones"
                v-model="computedRequest.clarifications"
                class="form-control"
                :class="{ 'has-errors': errors.length }"></textarea>
            </div>
            <span class="red-text">
...
<script>
  ...
  import { CLIENT_REQUESTS_ROUTE, CLIENT_REQUEST_EDIT_ROUTE } from 'Constants/clients/routes';
  ...
  export default {
    ...
    computed: {
      ...
      isEditing () {
        return this.$route.name === CLIENT_REQUEST_EDIT_ROUTE;
      },
    },
    ...
    methods: {
      ...
      create () {
        this.$store.dispatch('requests/create', this.computedRequest)
          .then(() => {
      ...
      edit () {
        this.$store.dispatch('requests/edit', this.computedRequest)
          .then(() => {
            this.$toast.success('Solicitud editada correctamente');
            this.goBack();
          })
          .catch((error) => {
            if (error.response.data.data.errors != null) {
